...
argument_spec.update(dict(
    ...
    notSyncedForMinutes=dict(type="str"),
    errorCode=dict(type="str"),
    errorDescription=dict(type="str"),
    ...
    license_name=dict(type="str"),
    license_type=dict(type="str"),
    license_status=dict(type="str"),
    module_name=dict(type="str"),
    module_equpimenttype=dict(type="str"),
    module_servicestate=dict(type="str"),
    module_vendorequipmenttype=dict(type="str"),
    module_partnumber=dict(type="str"),
    module_operationstatecode=dict(type="str"),
    id=dict(type="str"),
